...
// Check array for repeated entry useful to make sure we dont count a net twice
...
// Check that updated gains match calculation
...
// Full gain calculation not updates
