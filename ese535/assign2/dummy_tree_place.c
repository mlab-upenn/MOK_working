...
void random_place(int size, int cluster_size)
{
  ...
  // Alternate random seed to test for better solutions to example
  //my_srandom(1500);
...
void dummy_tree_place(int size, int cluster_size)
{
  ...
  random_place(size,cluster_size);
...
void dummy_tree_place_schedule(int *growth_schedule, int growth_schedule_length, int cluster_size)
{
  ...
  random_place(1<<growth_schedule_length,cluster_size);
