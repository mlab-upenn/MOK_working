...
// Helpers for later
int new_net(int whichPin, int *array)
{
  int i;
...
int KLFM(int current_height, struct tree_node *left_switch, struct tree_node *right_switch, int pmax, boolean *is_clock, int location)
{
  // Housekeeping
  int i;
  int l_max_gain_left;
