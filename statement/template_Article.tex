...
To achieve this, I developed a prototypical cyber-physical system complete with computation, control, and communication.  The blocks utilize a customized version of \textit{1-Wire}, a low-cost, minimal communications protocol from the HVAC industry in order to communicate state information amongst peers and a local master processor. This protocol and the algorithms I developed with it allows for a rich user experience that was previously not mechanically or economically feasible. The result is the digital distillation of a child's imagination, where other people and smart objects -- regardless of whether or not they are in the same room -- can interact with it.\\
