...
int which_branch(int max_gain_left, int max_gain_right, int *left, int pmax, int active_branch, ListPtr *buckets_left, ListPtr *buckets_right, int capacity);
...
void repartition(int height, int cluster_size, int *sub_left, int *sub_right, int location);

// Compute F and Ts for a subtree
void sub_F_and_T(int height, int *sub_left);

void recurse_tree(int height, int location, int pmax, boolean *is_clock, int capacity);
